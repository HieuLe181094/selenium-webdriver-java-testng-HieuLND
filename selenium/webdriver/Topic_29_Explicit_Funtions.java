...
public class Topic_29_Explicit_Funtions {
    ...
    @Test
    public void TC_01_() {
        // Wait cho element ko còn hiển thị trong HTML (trước đó là có tồn tại)
        explicitWait.until(ExpectedConditions.stalenessOf(driver.findElement(By.cssSelector(""))));

        // Wait cho element ko còn hiển thị (còn hoặc ko còn trong HTML)
        ...
        // Wait thỏa mãn cả 2 điều kiện (AND)
       ...
       // explicitWait.until(ExpectedConditions.elementSelectionStateToBe(By.cssSelector(""),"false"));
        ...
        List<WebElement> allNumberSelected = explicitWait.until(ExpectedConditions.numberOfElementsToBe(
                By.cssSelector("ol#selectable>li.ui-selected"),6));
